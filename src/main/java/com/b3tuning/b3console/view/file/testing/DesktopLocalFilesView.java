...
public class DesktopLocalFilesView extends BaseView<DesktopLocalFilesViewModel> {
	...
	private void subscribeToNotifications() {
		...
		manage(eventsOf(changeButton, ActionEvent.ACTION).subscribe(e -> viewModel.onChangeAction((Stage) changeButton.getScene().getWindow())));
		...
		viewModel.subscribe(DesktopLocalFilesViewModel.REFRESH_PAGE, (k, p) -> load(viewModel.browsePathProperty().get()));
